...
from . import FulfillmentTypes, ConditionTypes
...
class BlockstakeInput(BaseDataTypeClass):
    ...
    def fulfillment(self, value):
        ...
        if not isinstance(value, FulfillmentBaseClass):
            raise TypeError(
                "cannot assign value of type {} as a BlockstakeInput's fulfillment (expected: FulfillmentBaseClass subtype)".format(type(value)))
        self._fulfillment = value
    ...
    def parent_output(self, value):
        ...
        if not isinstance(value, BlockstakeOutput):
            raise TypeError(
                "cannot assign value of type {} as a BlockstakeInput's parent output (expected: BlockstakeOutput)".format(type(value)))
        self._parent_output = value
...
class BlockstakeOutput(BaseDataTypeClass):
    ...
    def condition(self, value):
        ...
        if not isinstance(value, ConditionBaseClass):
            raise TypeError(
                "cannot assign value of type {} as a BlockstakeOutput's condition (expected: ConditionBaseClass subtype)".format(type(value)))
        self._condition = value
