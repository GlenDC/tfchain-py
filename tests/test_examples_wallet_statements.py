...
def test():
    ...
    for txn in w.transactions:
        ...
        text +="""
            ...
            """.strip().format(('unconfirmed' if txn.unconfirmed else txn.height), str(txn.id),
