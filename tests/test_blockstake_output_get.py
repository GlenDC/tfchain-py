...
def test():
    ...
    assert str(bso.condition.unlockhash) == '015a080a9259b9d4aaa550e2156f49b1a79a64c7ea463d810d4493e8242e6791584fbdac553e6f'
    ...
    assert str(creation_txn.blockstake_inputs[0].parentid) == 'a877078376f423d4f7a477959adffdaa58e445f39ef00c94330d7bf89a053535'
