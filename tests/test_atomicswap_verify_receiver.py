...
def test():
    ...
    w.atomicswap.verify('dd1babcbab492c742983b887a7408742ad0054ec8586541dd6ee6202877cb486', secret_hash='e24b6b609b351a958982ba91de7624d3503f428620f5586fbea1f71807b545c1')
    # which will fail if the secret hash is wrong
    with pytest.raises(tfchain.errors.AtomicSwapContractInvalid):
        w.atomicswap.verify('dd1babcbab492c742983b887a7408742ad0054ec8586541dd6ee6202877cb486', secret_hash='e24b6b609b351a958982ba91de7624d3503f428620f5586fbea1f71807b545c2')
    ...
    w.atomicswap.verify('dd1babcbab492c742983b887a7408742ad0054ec8586541dd6ee6202877cb486',
            amount=50, secret_hash='e24b6b609b351a958982ba91de7624d3503f428620f5586fbea1f71807b545c1',
            min_refund_time='+1d', receiver=True, contract=contract)
