...
def test():
    ...
    explorer_client.mint_condition_add(
        condition=tfchain.types.ConditionTypes.from_recipient('01a006599af1155f43d687635e9680650003a6c506934996b90ae84d07648927414046f9f0e936'),
        height=0,
    )
    ...
    assert isinstance(result.transaction.mint_fulfillment, tfchain.types.FulfillmentTypes.FulfillmentSingleSignature)

    # define the current mint condition to be ours
    explorer_client.mint_condition_add(
        condition=tfchain.types.ConditionTypes.from_recipient('014ad318772a09de75fb62f084a33188a7f6fb5e7b68c0ed85a5f90fe11246386b7e6fe97a5a6a'),
        height=3643,
    )
    ...
    result = w.minter.coins_new(
        recipient=["015a080a9259b9d4aaa550e2156f49b1a79a64c7ea463d810d4493e8242e6791584fbdac553e6f", "014ad318772a09de75fb62f084a33188a7f6fb5e7b68c0ed85a5f90fe11246386b7e6fe97a5a6a"],
    ...
    result = w.minter.coins_new(
        recipient=(1, ["015a080a9259b9d4aaa550e2156f49b1a79a64c7ea463d810d4493e8242e6791584fbdac553e6f", "014ad318772a09de75fb62f084a33188a7f6fb5e7b68c0ed85a5f90fe11246386b7e6fe97a5a6a"]),
    ...
    explorer_client.mint_condition_add(
        condition=tfchain.types.ConditionTypes.from_recipient((1, [
    ...
    assert result.transaction.is_fulfilled()
    assert result.transaction.mint_fulfillment.is_fulfilled(parent_condition=c.minter.condition_get())
    assert isinstance(result.transaction.mint_fulfillment, tfchain.types.FulfillmentTypes.FulfillmentMultiSignature)
